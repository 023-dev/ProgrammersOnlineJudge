...
2024년 04월 24일 12:47:01

### 문제 설명

<p data-sider-select-id="b179193d-53b8-468d-9dc4-e65b898a4743">머쓱이는 태어난 지 11개월 된 조카를 돌보고 있습니다. 조카는 아직 "aya", "ye", "woo", "ma" 네 가지 발음과 네 가지 발음을 조합해서 만들 수 있는 발음밖에 하지 못하고 연속해서 같은 발음을 하는 것을 어려워합니다. 문자열 배열 <code>babbling</code>이 매개변수로 주어질 때, 머쓱이의 조카가 발음할 수 있는 단어의 개수를 return하도록 solution 함수를 완성해주세요.</p>
...
<th>result</th>
        ...
        <tbody><tr>
<td data-sider-select-id="024d37c1-d109-4ff0-af6a-fd5fa85b04dd">["aya", "yee", "u", "maa"]</td>
<td>1</td>
</tr>
<tr>
